...
namespace wali
{
  ...
  class IUserHandler : public IWaliHandler
  {
    ...
    public:
      ...
      virtual sem_elem_t getWeight(std::string msgcode, Key fromStkKey) = 0;

    /* Move later the following two functions */
    virtual void setCaller(std::string c) = 0;
    virtual void setCallee(std::string c) = 0;
       ...
       */
    virtual merge_fn_t getMergeFn(sem_elem_t se, Key fromStkKey) = 0;
